...
vrcb=VideoRecorderCallback(eval_env, render_freq=log_freq, deterministic=True, modelname=f"{modelname}{game}")
callback = CallbackList([vrcb,  EvalCallback(eval_env, best_model_save_path=f"{log_path}{modelname}{game}best_model",
